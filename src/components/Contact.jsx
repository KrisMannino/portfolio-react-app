...
const Contact = () => {
  ...
  <div name='contact' className='w-full min-h-screen sm:h-screen flex justify-center items-center p-4 pt-20 pb-20 mt-40' >
        <form method='POST' action="https://getform.io/f/jbwljmya" className='flex flex-col max-w-[600px] w-full'>
          <div className='pb-8'>
            
            <p className='sm:text-9xl font-bold inline border-b-4' style={{ borderBottomColor: 'var(--bg-900)', color: 'var(--bg-900)'}}>Contact</p>
               <p className='py-4 max-w-[1200px] md:mr-[30%] sm:text-4xl mt-2' style={{ color: 'var(--text-muted)' }}>Submit the form or shoot me an email for a resume</p>
